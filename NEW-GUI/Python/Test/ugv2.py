...
json_file_path = '/Users/shivanshchauhan/Desktop/Work/UAS/GUI/main/NEW-GUI/Python/Test/test2.json'
    ...
    while True:
        try:
            ...
            with open(json_file_path, 'r') as file:
                ...
                sio.emit('data2', json_data, namespace=namespace)
